...
def myNetwork():
    ...
    linkopt5=dict(bw=5,delay='1ms',loss=0)

    linkopt10=dict(bw=10,delay='1ms',loss=0)

    linkopt15=dict(bw=15,delay='1ms',loss=0)
    
    linkopt20=dict(bw=20,delay='1ms',loss=0)
    ...
    net.addLink(sw1, sw3)
    net.addLink(sw2, sw4)
    # net.addLink(sw2, sw3) -> commented to remove cycle
    # net.addLink(sw1, sw4) -> commented to remove cycle
    ...
    net.addLink(sw5, sw7)
    net.addLink(sw6, sw8)
    # net.addLink(sw6, sw7) -> commented to remove cycle
    # net.addLink(sw5, sw8) -> commented to remove cycle
    ...
    # net.addLink(sw10, sw11) -> commented to remove cycle
    # net.addLink(sw9, sw12) -> commented to remove cycle
    ...
    # net.addLink(sw3, sw14, bw=10) -> commented to remove cycle
    ...
    # net.addLink(sw12, sw15, cls=TCLink, bw=15) -> commented to remove cycle
